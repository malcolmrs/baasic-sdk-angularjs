/*
 Baasic AngularJS SDK v2.0.3-inter08
...
(function (angular, undefined) { /* exported module */
    ...
    /** 
     * @description The angular.module is a global place for creating, registering or retrieving modules. All modules should be registered in an application using this mechanism. An angular module is a container for the different parts of your app - services, directives etc. In order to use `baasic.messageCenter` module functionality it must be added as a dependency to your app.
     * @copyright (c) 2018 Mono Ltd
     * @license MIT
     * @author Mono Ltd
     * @module baasic.messageCenter
     * @example
     (function (Main) {
     "use strict";
     var dependencies = [
     ...
     (MyApp.Modules.Main = {})); 
     */
    var module = angular.module('baasic.messageCenter', ['baasic.api']); /* globals module */
    /**
     * @module baasicMessageCenterChannelService
     * @description Baasic Message Center Channel Service provides Baasic route templates which can be expanded to Baasic REST URIs. Various services can use Baasic Message Center Chanel Route Service to obtain needed routes while other routes will be obtained through HAL. By convention, all route services use the same function names as their corresponding services.
     */

    (function (angular, module, undefined) {
        'use strict';
        module.service('baasicMessageCenterChannelService', ['baasicApp', function (baasicApps) {
            var baasicApp = baasicApps.get();
            return {
                 ...
                 * @method        
                 * @example 
                 baasicMessageCenterChannelService.find({
                 pageNumber : 1,
                 pageSize : 10,
                 orderBy : '<field>',
                 orderDirection : '<asc|desc>',
                 ...
                 **/
                find: function (options) {
                    return baasicApp.messageCenterModule.channel.find(options);
                },
                 ...
                 * @method        
                 * @example 
                 baasicMessageCenterChannelService.get()
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                get: function (id, options) {
                    return baasicApp.messageCenterModule.channel.get(id, options);
                },
                 ...
                 * @example 
                 baasicMessageCenterChannelService.create({   
                 name?: '<name>',
                 memberIds?: '<memberIds>'
                 })
                 .then(function (data) {   
                 ...
                 **/
                create: function (data) {
                    return baasicApp.messageCenterModule.channel.create(data);
                },

                /**
                 * Returns a promise that is resolved once the update channel action has been performed; this action updates a channel resource. 
                 * @method        
                 * @example 
                 // channel is a resource previously fetched using get action.
                 channel.name = '<name>';
                 baasicMessageCenterChannelService.update(channel)
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                update: function (data) {
                    return baasicApp.messageCenterModule.channel.update(data);
                },

                /**
                 * Returns a promise that is resolved once the remove action has been performed. This action will remove a channel resource from the system if successfully completed. 
                 * @method        
                 * @example 
                 // channel is a resource previously fetched using get action.				 
                 baasicMessageCenterChannelService.remove(channel)
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                remove: function (data) {
                    return baasicApp.messageCenterModule.channel.remove(data);
                },


                /**
                 * Returns a promise that is resolved once the purge action has been performed. This action will remove all channel resources from the system if successfully completed. 
                 * @method        
                 * @example 			 
                 baasicMessageCenterChannelService.purge()
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                purge: function () {
                    return baasicApp.messageCenterModule.channel.purge();
                },
                ...
                batch: {
                     ...
                     * @method batch.create       
                     * @example 
                     baasicMessageCenterChannelService.batch.create([{
                     name?: '<name>',
                     memberIds?: '<memberIds>' 
                     }])
                     .success(function (data) {
                     ...
                     **/
                    create: function (data) {
                        return baasicApp.messageCenterModule.channel.batch.create(data);
                    },
                     ...
                     **/
                    update: function (data) {
                        return baasicApp.messageCenterModule.channel.batch.update(data);
                    },
                     ...
                     * @method batch.remove       
                     * @example 			 
                     baasicMessageCenterChannelService.batch.remove(channelIds)
                     .success(function (data) {
                     // perform success action here
                     })
                     .error(function (response, status, headers, config) {
                     ...
                     **/
                    remove: function (ids) {
                        return baasicApp.messageCenterModule.channel.batch.remove(ids);
                    }
                }
            };
        }]);
    ...
    /* globals module */
    /**
     * @module baasicMessageCenterChannelMemberService
     * @description Baasic Message Center Channel Member Service provides Baasic route templates which can be expanded to Baasic REST URIs. Various services can use Baasic Message Center Chanel Member Route Service to obtain needed routes while other routes will be obtained through HAL. By convention, all route services use the same function names as their corresponding services.
     */

    (function (angular, module, undefined) {
        'use strict';
        module.service('baasicMessageCenterChannelMemberService', ['baasicApp', function (baasicApps) {
            var baasicApp = baasicApps.get();
            return {
                /**
                 ...
                 * @method        
                 * @example 
                 baasicMessageCenterChannelMemberService.find({
                 pageNumber : 1,
                 pageSize : 10,
                 orderBy : '<field>',
                 orderDirection : '<asc|desc>',
                 ...
                 **/
                find: function (options) {
                    return baasicApp.messageCenterModule.member.find(options);
                },
                 ...
                 * @method        
                 * @example 
                 baasicMessageCenterChannelMemberService.get()
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                get: function (id, options) {
                    return baasicApp.messageCenterModule.member.get(id, options);
                },
                 ...
                 * @example 
                 baasicMessageCenterChannelMemberService.create({   
                 channelId: '<channelId>',
                 ...
                 **/
                create: function (data) {
                    return baasicApp.messageCenterModule.member.create(data);
                },

                /**
                 * Returns a promise that is resolved once the update member action has been performed; this action updates a member resource. 
                 * @method        
                 * @example 
                 // member is a resource previously fetched using get action.
                 member.hasHistoryAccess = '<hashistoryAccess>'; 
                 baasicMessageCenterChannelMemberService.update(member)
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                update: function (data) {
                    return baasicApp.messageCenterModule.member.update(data);
                },

                /**
                 * Returns a promise that is resolved once the remove action has been performed. This action will remove a memeber resource from the system if successfully completed. 
                 * @method        
                 * @example 
                 // member is a resource previously fetched using get action.				 
                 baasicMessageCenterChannelMemberService.remove(member)
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                remove: function (data) {
                    return baasicApp.messageCenterModule.member.remove(data);
                },
                ...
                batch: {
                     ...
                     * @method batch.create       
                     * @example 
                     baasicMessageCenterChannelMemberService.batch.create([{
                     channelId: '<channelId>',
                     hasHistoryAccess?: '<hasHistoryAccess>' 
                     }])
                     .success(function (data) {
                     ...
                     **/
                    create: function (data) {
                        return baasicApp.messageCenterModule.member.batch.create(data);
                    },
                     ...
                     **/
                    update: function (data) {
                        return baasicApp.messageCenterModule.member.batch.update(data);
                    },
                     ...
                     * @method batch.remove       
                     * @example 			 
                     baasicMessageCenterChannelMemberService.batch.remove(memberIds)
                     .success(function (data) {
                     // perform success action here
                     })
                     .error(function (response, status, headers, config) {
                     ...
                     **/
                    remove: function (ids) {
                        return baasicApp.messageCenterModule.member.batch.remove(ids);
                    }
                }
            };
        }]);
    ...
    /* globals module */
    /**
     * @module baasicMessageCenterChannelMessageService
     * @description Baasic Message Center Channel Message Service provides Baasic route templates which can be expanded to Baasic REST URIs. Various services can use Baasic Message Center Chanel Message Route Service to obtain needed routes while other routes will be obtained through HAL. By convention, all route services use the same function names as their corresponding services.
     */

    (function (angular, module, undefined) {
        'use strict';
        module.service('baasicMessageCenterChannelMessageService', ['baasicApp', function (baasicApps) {
            var baasicApp = baasicApps.get();
            return {
                /**
                 ...
                 * @method        
                 * @example 
                 baasicMessageCenterChannelMessageService.find({
                 pageNumber : 1,
                 pageSize : 10,
                 orderBy : '<field>',
                 orderDirection : '<asc|desc>',
                 ...
                 **/
                find: function (options) {
                    return baasicApp.messageCenterModule.message.find(options);
                },
                 ...
                 * @method        
                 * @example 
                 baasicMessageCenterChannelMessageService.get()
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                get: function (id, options) {
                    return baasicApp.messageCenterModule.message.get(id, options);
                },
                 ...
                 * @example 
                 baasicMessageCenterChannelMessageService.create({   
                 channelId: '<channelId>', 
                 message?: '<message>'
                 })
                 .then(function (data) {   
                 ...
                 **/
                create: function (data) {
                    return baasicApp.messageCenterModule.message.create(data);
                },

                /**
                 * Returns a promise that is resolved once the update message action has been performed; this action updates a message resource. 
                 * @method        
                 * @example 
                 // message is a resource previously fetched using get action.
                 message.message = '<message>'; 
                 baasicMessageCenterChannelMessageService.update(message)
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                update: function (data) {
                    return baasicApp.messageCenterModule.message.update(data);
                },
                 ...
                 * @example 
                 // message is a resource previously fetched using get action.				 
                 baasicMessageCenterChannelMessageService.remove(message)
                 .success(function (data) {
                 // perform success action here
                 })
                 .error(function (response, status, headers, config) {
                 ...
                 **/
                remove: function (data) {
                    return baasicApp.messageCenterModule.message.remove(data);
                },
                ...
                batch: {
                     ...
                     * @method batch.create       
                     * @example 
                     baasicMessageCenterChannelMessageService.batch.create([{
                     channelId: '<channelId>', 
                     message?: '<message>'
                     }])
                     .success(function (data) {
                     ...
                     **/
                    create: function (data) {
                        return baasicApp.messageCenterModule.message.batch.create(data);
                    },
                     ...
                     **/
                    update: function (data) {
                        return baasicApp.messageCenterModule.message.batch.update(data);
                    },
                     ...
                     * @method batch.remove       
                     * @example 			 
                     baasicMessageCenterChannelMessageService.batch.remove(messageIds)
                     .success(function (data) {
                     // perform success action here
                     })
                     .error(function (response, status, headers, config) {
                     ...
                     **/
                    remove: function (ids) {
                        return baasicApp.messageCenterModule.message.batch.remove(ids);
                    }
                }
            };
        }]);
